...
1) Windows Subsystem Linux (WSL) is **not** automatically enabled on windows. So, to start off, we need to enable it!
   ...
   ![toggle windows features](images/turn-windows-features-on-or-off.png)

   c. Scroll down until you see "Windows Subsystem for Linux" - ensure its box
   is checked!

   ![wsl checkbox](images/wsl-turnon.png)  

   d. Scroll up a bit until you see "Virtual Machine Platform." Turn this
   feature on as well.

   ![virtual machine platform checkbox](images/wsl-virtual-machine-platform.png)  
...
![ubuntu choice in microsoft store](images/ubuntu-choice.png)    
...
6) Open up the Ubuntu app. Follow the prompts, which will include making a username and password. Don't forget your password!  
   ...
   ![open ubuntu](images/open-ubuntu.png)  
...
15) To configure your Ubuntu terminal to be available in VSCode:
  ...
  ![command palette](images/default-shell.png)  

   - Once you select it, a few options will pop up. You want to select WSL

  ![WSL Terminal](images/wsl-bash-selection.png)
...
17) Additional User Settings *(OPTIONAL)*:
  ...
  ![Preferences - settings](images/settings-json.png)
    
  - You will see a screen like this:

  ![Preferences - settings](images/user-settings.png)
...
![linux file system](images/linux_fs.png)
...
![linux file system](images/linux_fs_path.png)
...
![PGAdmin in start](images/pgadmin-start.png)

 - This should open up pgAdmin in your browser. Start a server by right-clicking "PostgreSQL" and selecting "Connect Server"

![PostgreSQL selection](images/start-server.png)
![PostgreSQL connect](images/connect-server.png)
...
![create user](images/pgadmin-create-user.png)  

![create user permissions](images/create-user-permissions.png)
...
![database works](images/database-works.png)
...
![find services ](images/find_services.png)
...
![Lxss Manager](images/lxss_manager.png)
